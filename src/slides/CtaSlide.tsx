  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 h-full flex flex-col px-10 lg:px-20 py-12 pb-20">
        ...
        <div className="flex-1 flex flex-col lg:flex-row items-start lg:items-center gap-10 lg:gap-16">
          <div className="flex-1 max-w-2xl">
            <motion.h2
              initial={{ opacity: 0, x: -25 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.2, duration: 0.7 }}
              className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-heading italic text-white leading-[0.85] tracking-tight mb-8"
            >
            ...
            <motion.p
              ...
              className="text-white/90 font-body font-normal text-xl md:text-2xl leading-relaxed"
            >
          ...
          <div className="w-full lg:w-[420px] flex flex-col gap-5 shrink-0">
            {facts.map((f, i) => (
              <motion.div
                ...
                className="liquid-glass rounded-2xl p-6 flex items-start gap-5 cursor-default"
              >
                ...
                <div>
                  <h3 className="text-2xl font-body font-semibold text-white mb-1">{f.title}</h3>
                  <p className="text-lg font-body font-normal text-white/90 leading-relaxed">{f.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
